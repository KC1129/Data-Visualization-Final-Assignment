...
@app.callback( [Output(component_id='plot1', component_property='value'),
                ...
                Output(component_id='plot3', component_property='value'),
                Output(component_id='plot4', component_property='value'),
                Output(component_id='plot5', component_property='value')],
